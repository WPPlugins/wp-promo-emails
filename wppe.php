...
/*
  Copyright (c) 2016 Craig Freeman (email :ceo@cbfreeman.com)
 ...
 function email_install()
{
 ...
 global $wpdb;
 $wpdb->query(
	"UPDATE $wpdb->users SET subscriber ='T' WHERE user_email ='$void' LIMIT 1 ");
	
 echo "<div style='background:#FFF;border:1px solid #ddd;border-radius:6px;max-width:580px;margin:0 auto;padding:34px 0 24px;width:580px;'>";
 echo "<h2>You will be missed</h2>";
 echo "The following email address" . $void . "has been removed from our mailing list.";
 echo "Thank for visiting with us. We hope you will come back soon and bring a friend.";
 echo "<br>";
 echo "<br>";
 echo "<br>";
 echo  "Thanks,";
